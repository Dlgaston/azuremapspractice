...
const resources = require('./resources-2b0eb58d.js');
...
const Link = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: 'f3c88f34e5fddf3cb7779cabbac20ecd7fc62be1', class: "calcite-link--icon icon-start", flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: "s" }));
        const iconEndEl = (index.h("calcite-icon", { key: '684df779ad349e596dbe9f128c035077d0c75d93', class: "calcite-link--icon icon-end", flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: "s" }));
        const Tag = childElType;
        const role = childElType === "span" ? "link" : null;
        const tabIndex = childElType === "span" ? 0 : null;
        return (index.h(index.Host, { key: 'b8bf6a472945947d6bac9853d2322f8fedca5102', role: "presentation" }, index.h(interactive.InteractiveContainer, { key: 'e410a5b86b4d11dc12dbc4f60f8eae6e315f3b7d', disabled: this.disabled }, index.h(Tag, { key: '4e22e764e60b0446f4840ba745dba9eae90a7809', class: { [resources.CSS_UTILITY.rtl]: dir === "rtl" },
            /*
          ...
          */
            ...
            ref: this.storeTagRef }, this.iconStart ? iconStartEl : null, index.h("slot", { key: 'eb1700118698d9c0a7dc5863bbe6bb7c03daa61b' }), this.iconEnd ? iconEndEl : null))));
    }
    //--------------------------------------------------------------------------
    //
    //  Events
