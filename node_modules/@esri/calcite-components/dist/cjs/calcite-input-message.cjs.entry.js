...
const InputMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7d7329dbca2d5abb5a9b92dbee9767ba14488caa', "calcite-hydrated-hidden": hidden }, this.renderIcon(this.requestedIcon), index.h("slot", { key: '2fc037f47b40f25698cecdd52df9436da86ecfcf' })));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
