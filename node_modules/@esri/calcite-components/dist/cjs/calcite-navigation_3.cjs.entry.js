...
const dom = require('./dom-d6c2a698.js');
const loadable = require('./loadable-52c88e74.js');
const Heading = require('./Heading-898a2c03.js');
require('./guid-4b381af5.js');
require('./resources-2b0eb58d.js');
...
const CalciteNavigation = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8bbdbb63ced5dbf54b0e2f7d21327780ec02c461' }, index.h("div", { key: '30f9b294f2d7589b879ebf6444c7d50291544395', class: {
            ...
            } }, index.h("div", { key: 'b5e645212bd0eb7fe7188fedf8a9a97022012698', class: { [CSS$2.hide]: !this.progressSlotHasElement, [SLOTS.progress]: true } }, index.h("slot", { key: '138fe1bcec98a49c9d2a70ab13c057f2e5f14b7c', name: SLOTS.progress, onSlotchange: this.handleProgressSlotChange })), index.h("div", { key: 'ef62d2575a2620b8530a4fc2e1df97adce0fabd7', class: { [CSS$2.containerContent]: true, [CSS$2.hasProgress]: this.progressSlotHasElement } }, this.renderMenuAction(), index.h("div", { key: 'c775762b072e199be013daa9821fcb9833ac08b8', class: { [CSS$2.hide]: !this.logoSlotHasElements, [SLOTS.logo]: true } }, index.h("slot", { key: '6925a8a345685c3bb90d5e994454c24bac80611a', name: SLOTS.logo, onSlotchange: this.handleLogoSlotChange })), index.h("slot", { key: '0121dc1a80006070b325c19e73a80f0374301392', name: SLOTS.contentStart, onSlotchange: this.handleContentStartSlotChange }), index.h("slot", { key: '3257e07e02c5aa5ae517306069eed4ca8abf3b8f', name: SLOTS.contentCenter, onSlotchange: this.handleContentCenterSlotChange }), index.h("slot", { key: '23f105f826d3fe35f9270b552927bbf89aa7dbbd', name: SLOTS.contentEnd, onSlotchange: this.handleContentEndSlotChange }), index.h("div", { key: '469ad09b41f4cbdc09473065fa5fcf8638a82c1d', class: { [CSS$2.hide]: !this.userSlotHasElements, [SLOTS.user]: true } }, index.h("slot", { key: '78bb1fe16546fa871887991ab1916fb32ebf8186', name: SLOTS.user, onSlotchange: this.handleUserSlotChange })))), index.h(index.Fragment, { key: '28d6c126b06c4c4a52c425e90772c5f151468014' }, index.h("slot", { key: '913e9cce3188cc23d87eb0471f5d91cbdb3788b8', name: SLOTS.navSecondary, onSlotchange: this.handleSecondarySlotChange }), index.h("slot", { key: 'ff4d86c572567ca4993b6091185fc9d48ecb1ab0', name: SLOTS.navTertiary, onSlotchange: this.handleTertiarySlotChange }))));
    }
...
const CalciteNavigationLogo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cd8a1c95e9c72a494942c09285db6ce4e554e6a1' }, index.h("a", { key: 'bcb1a269e0d6cde0969de9d822f1f98e689f826a', class: CSS$1.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && index.h("img", { key: 'c028ae89a0e3ae62e90280e3646894e9ee70458b', alt: this.label || "", class: CSS$1.image, src: thumbnail }), this.icon && this.renderIcon(), this.renderHeaderContent())));
    }
