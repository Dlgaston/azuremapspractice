...
const Checkbox = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, { key: '6ef0c5b4fe62f003d9fe1ea6979cb5aeb564dac7', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: '72f94ddb0795e2e0d10aac69af05c1ce7d6e5ead', disabled: this.disabled }, index.h("div", { key: '1cfc46f5a7180d6cd52962a26488c66eec14d852', "aria-checked": dom.toAriaBoolean(this.checked), "aria-label": label.getLabelText(this), class: "toggle", onBlur: this.onToggleBlur, onFocus: this.onToggleFocus, role: "checkbox", tabIndex: this.disabled ? undefined : 0,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (toggleEl) => (this.toggleEl = toggleEl) }, index.h("svg", { key: '4956ac9d598af8267781610220896e07aad56c65', "aria-hidden": "true", class: "check-svg", viewBox: "0 0 16 16" }, index.h("path", { key: 'bd650b149977569e00a99be2fbc8a836cbfd4cfe', d: this.getPath() })), index.h("slot", { key: '604e420b7fe7014a202991d0e5c992e57d540d16' })), index.h(form.HiddenFormInputSlot, { key: '9ec0eab7c20a9dffed6a1a9b517ece8b8ed1cb26', component: this }))));
    }
