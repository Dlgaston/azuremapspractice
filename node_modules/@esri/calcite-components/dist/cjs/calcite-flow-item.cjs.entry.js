...
const locale = require('./locale-801208c5.js');
const t9n = require('./t9n-9d0bfc6a.js');
const resources = require('./resources-b17d9cb0.js');
require('./guid-4b381af5.js');
require('./resources-2b0eb58d.js');
require('./browser-23ebed5a.js');
require('./key-2ea701e3.js');
require('./observers-7d0e25b9.js');
...
const FlowItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ab926d381ff2493f3fd49a5c8724260211d69ca9' }, index.h(interactive.InteractiveContainer, { key: '6799b56c2116de5e08739ddc2ec1557bd291f3f8', disabled: disabled }, index.h("calcite-panel", { key: '2e438b8abf573eabaaa2e966dcca5c4843a53cba', closable: closable, closed: closed, collapseDirection: collapseDirection, collapsed: collapsed, collapsible: collapsible, description: description, disabled: disabled, heading: heading, headingLevel: headingLevel, loading: loading, menuOpen: menuOpen, messageOverrides: messages, onCalcitePanelClose: this.handlePanelClose, onCalcitePanelScroll: this.handlePanelScroll, onCalcitePanelToggle: this.handlePanelToggle, overlayPositioning: overlayPositioning,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setContainerRef }, this.renderBackButton(), index.h("slot", { key: '39b650abdf64df16f535d45f64dc1b367acfcc9e', name: SLOTS.actionBar, slot: resources.SLOTS.actionBar }), index.h("slot", { key: '5b36c56874ad762f842c81f9ffbdcdbd3168cf75', name: SLOTS.headerActionsStart, slot: resources.SLOTS.headerActionsStart }), index.h("slot", { key: '2dbf552425d238a4479a12bbec79571d11124577', name: SLOTS.headerActionsEnd, slot: resources.SLOTS.headerActionsEnd }), index.h("slot", { key: '2dd0a30236844c91c2cf10a9fbacbe9935ea234c', name: SLOTS.headerContent, slot: resources.SLOTS.headerContent }), index.h("slot", { key: '1b025f746e2e7d58fb057aab36b24e46872e607e', name: SLOTS.headerMenuActions, slot: resources.SLOTS.headerMenuActions }), index.h("slot", { key: '5dd5986e93dcc11e0b0fade6822814b160053c70', name: SLOTS.fab, slot: resources.SLOTS.fab }), index.h("slot", { key: 'e7cf2702cd2e423d07a8a8ac57c142bc4738b3ef', name: SLOTS.footerActions, slot: resources.SLOTS.footerActions }), index.h("slot", { key: 'e2561d89aaebe4fbb82b1f546551d05ebb23b0bf', name: SLOTS.footer, slot: resources.SLOTS.footer }), index.h("slot", { key: 'fb6bf40456038f84486b2858765bb9d147800e84' })))));
    }
