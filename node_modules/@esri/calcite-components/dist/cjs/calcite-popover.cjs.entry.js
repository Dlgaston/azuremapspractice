...
const FloatingArrow = require('./FloatingArrow-a765cfc0.js');
...
const Popover = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c6ca86d9bde93db52f3abc95344e8bff9e245517', "aria-hidden": dom.toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, index.h("div", { key: '1e1054bfa6ac2e762b8ba49b0148330c6e3e4bd8', class: {
                [floatingUi.FloatingCSS.animation]: true,
                [floatingUi.FloatingCSS.animationActive]: displayed,
            },
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setTransitionEl }, arrowNode, index.h("div", { key: 'e9d6f6a86b2f433625df8436bc7bbea1dcdd5c60', class: {
                [CSS.hasHeader]: !!heading,
                [CSS.container]: true,
            } }, this.renderHeader(), index.h("div", { key: '64845f98d4666edc418aa119c3fd7c592d41ee48', class: CSS.content }, index.h("slot", { key: '24a55594fb96fb227012406096f74b7646b58b9e' })), !heading ? this.renderCloseButton() : null))));
    }
