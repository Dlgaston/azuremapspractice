...
const Dropdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'aad82a6a5bce5a29f6c309bb9ff20911b3ec9482' }, index.h(interactive.InteractiveContainer, { key: 'b559473528a0142c058c6e6de499e981748e369c', disabled: this.disabled }, index.h("div", { key: '089a4a3e39800339c21e50f167c1154dd90f0194', class: "calcite-trigger-container", id: `${guid}-menubutton`, onClick: this.openCalciteDropdown, onKeyDown: this.keyDownHandler,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setReferenceEl }, index.h("slot", { key: '1a6ded94e643359a5d9a6168d3abe0db4d96d57e', "aria-controls": `${guid}-menu`, "aria-expanded": dom.toAriaBoolean(open), "aria-haspopup": "menu", name: SLOTS.dropdownTrigger, onSlotchange: this.updateTriggers })), index.h("div", { key: '3c8a8fcda5b885baadd1aaaf2b8181b9dfd24ddf', "aria-hidden": dom.toAriaBoolean(!open), class: "calcite-dropdown-wrapper",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setFloatingEl }, index.h("div", { key: '8c04cadcb38268f20386f9e80f519b99f702054e', "aria-labelledby": `${guid}-menubutton`, class: {
                ["calcite-dropdown-content"]: true,
                [floatingUi.FloatingCSS.animation]: true,
                [floatingUi.FloatingCSS.animationActive]: open,
            }, id: `${guid}-menu`, role: "menu",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setScrollerAndTransitionEl }, index.h("slot", { key: '92b1d20e253dc2253aa2f998076bf640e696ff91', onSlotchange: this.updateGroups }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
