...
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-8dda3b79.js';
import { e as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-fc68a30a.js';
    ...
    if (mode === "offset") {
        if (!timeZoneGroups) {
            timeZoneGroups = Promise.all([
                import('./index-61ccd2d9.js'),
                import('./index-b8200535.js'),
            ]);
        }
