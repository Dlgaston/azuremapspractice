 ...
 * v2.8.3
 */
import { r as registerInstance, c as createEvent, f as forceUpdate, h, H as Host, g as getElement } from './index-aad43fe9.js';
import { f as filterComputedPlacements, c as connectFloatingUI, b as defaultOffsetDistance, a as disconnectFloatingUI, r as reposition, F as FloatingCSS } from './floating-ui-cc89c877.js';
import { d as deactivateFocusTrap, a as activateFocusTrap, c as connectFocusTrap, u as updateFocusTrapElements } from './focusTrapComponent-57b40800.js';
import { x as isKeyboardTriggeredClick, t as toAriaBoolean, f as focusFirstTabbable, q as queryElementRoots } from './dom-f20a2cef.js';
import { g as guid } from './guid-61099ad8.js';
import { o as onToggleOpenCloseComponent } from './openCloseComponent-ef904cc3.js';
import { H as Heading } from './Heading-c7193081.js';
import { c as connectLocalized, d as disconnectLocalized } from './locale-fc68a30a.js';
import { u as updateMessages, c as connectMessages, s as setUpMessages, d as disconnectMessages } from './t9n-afcafb6c.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-f0718ca4.js';
import { c as createObserver } from './observers-372e145d.js';
import { F as FloatingArrow } from './FloatingArrow-e6430a9f.js';
import { g as getIconScale } from './component-154b01bb.js';
import { i as isActivationKey } from './key-22771b72.js';
import './debounce-f5c7e652.js';
...
const Popover = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'c6ca86d9bde93db52f3abc95344e8bff9e245517', "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, h("div", { key: '1e1054bfa6ac2e762b8ba49b0148330c6e3e4bd8', class: {
                [FloatingCSS.animation]: true,
                [FloatingCSS.animationActive]: displayed,
            },
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setTransitionEl }, arrowNode, h("div", { key: 'e9d6f6a86b2f433625df8436bc7bbea1dcdd5c60', class: {
                [CSS.hasHeader]: !!heading,
                [CSS.container]: true,
            } }, this.renderHeader(), h("div", { key: '64845f98d4666edc418aa119c3fd7c592d41ee48', class: CSS.content }, h("slot", { key: '24a55594fb96fb227012406096f74b7646b58b9e' })), !heading ? this.renderCloseButton() : null))));
    }
